...
namespace Starmessage.Master
{
   ...
   {
        public GameSettingMasterTable GameSettingMasterTable { get; private set; }
        public TestMasterTable TestMasterTable { get; private set; }

        public MemoryDatabase(
            GameSettingMasterTable GameSettingMasterTable,
            TestMasterTable TestMasterTable
        )
        {
            this.GameSettingMasterTable = GameSettingMasterTable;
        ...
        {
            this.GameSettingMasterTable = ExtractTableData<GameSettingMaster, GameSettingMasterTable>(header, databaseBinary, options, xs => new GameSettingMasterTable(xs));
        ...
        public DatabaseBuilder ToDatabaseBuilder()
        {
            ...
            builder.Append(this.GameSettingMasterTable.GetRawDataUnsafe());
        ...
        public ValidateResult Validate()
        {
            ...
            {
                GameSettingMasterTable,
                TestMasterTable,
            });

            ((ITableUniqueValidate)GameSettingMasterTable).ValidateUnique(result);
            ValidateTable(GameSettingMasterTable.All, database, "Key", GameSettingMasterTable.PrimaryKeySelector, result);
            ((ITableUniqueValidate)TestMasterTable).ValidateUnique(result);
            ValidateTable(TestMasterTable.All, database, "Key", TestMasterTable.PrimaryKeySelector, result);
        ...
        public static object GetTable(MemoryDatabase db, string tableName)
        {
            switch (tableName)
            {
                case "game_setting_master":
                    return db.GameSettingMasterTable;
                case "test_master":
        ...
        public static MasterMemory.Meta.MetaDatabase GetMetaDatabase()
        {
            ...
            dict.Add("game_setting_master", Starmessage.Master.Tables.GameSettingMasterTable.CreateMetaTable());
            dict.Add("test_master", Starmessage.Master.Tables.TestMasterTable.CreateMetaTable());
